...
class ByYouController extends Controller
{
    ...
    public function getByYou(){
    	$result = Challenge::join('ChallengedUser','Challenge.ID','=','ChallengedUser.ChallengeID')
    							...
    							->select('Template.Title','Template.Description','Template.Category','Challenge.BountyAmount','Challenge.Paid','ChallengedUser.Status','ChallengedUser.ProofDescription','ChallengedUser.ProofLink', 'User.Name');
